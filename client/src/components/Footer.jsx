    ...
    <Footer container className='border border-t-8 border-teal-500'>
      <div className='w-full max-w-7xl mx-auto'>
        <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
          <div className='mt-5'>
            <Link to="/about" className='self-center whitespace-nowrap text-sm sm:text-xl font-semibold dark:text-white'>
          ...
          <div>
            ...
            <Footer.LinkGroup col>
              <Footer.Link href='https://github.com/MamenFB' target='_blank' rel='noopener noreferrer'>
                Github
              </Footer.Link>
      ...
      <div className='w-full sm:flex sm:items-center sm:justify-between'>
        <Footer.Copyright href='#' by="Mamen blog" year={new Date().getFullYear()} />
